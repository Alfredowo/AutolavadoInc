...
DROP TABLE if EXISTS empleadodeldia;
...
INSERT INTO usuarios VALUES(NULL,'Alfred','123','Empleado');
INSERT INTO usuarios VALUES(NULL,'Lupe','123','Admin');
INSERT INTO vehiculos VALUES(NULL, 'Triciclo', 'Llantas', 5.0);
INSERT INTO cobros VALUES(NULL, 'Hector', 3, 1, 3, '2024-04-25', 15); 
INSERT INTO cobros VALUES(NULL, 'Mario', 2, 1, 3, '2024-04-20', 25);
...
INSERT INTO vehiculos VALUES(NULL, 'Camioneta', 'Puerta', 15);
...
SELECT * FROM usuarios;
SELECT * FROM pagos;
SELECT * FROM empleadodeldia;

INSERT INTO pagos VALUES(NULL,2,'2024-04-25',15);
INSERT INTO empleadodeldia VALUES(NULL,'2024-04-25',2,6,60);
SELECT * FROM usuarios;
SELECT *FROM cobros;
SELECT * FROM empleadodeldia;


SELECT * FROM resultados_lavados_por_empleado;
SELECT * FROM cobros;
INSERT INTO cobros VALUES(NULL, 'Hector', 3, 1, 3, '2024-04-25', 15); 
INSERT INTO cobros VALUES(NULL, 'Mario', 2, 1, 3, '2024-04-20', 25);
